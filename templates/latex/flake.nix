      ...
      let
        ...
        init = pkgs.writeShellApplication {
          ...
          text = ''
            ...
            nix run "$repo#new" -- --template latex --dest "$tmp" -- "$@"
            ...
            echo "Next: direnv allow (if you use direnv)"
            echo "Then: just init && just build"
          '';
        };
      in
      {
        apps = {
          init = {
            ...
            meta.description = "Bootstrap the LaTeX template into the current directory.";
          };
          default = {
            type = "app";
            program = "${init}/bin/init";
